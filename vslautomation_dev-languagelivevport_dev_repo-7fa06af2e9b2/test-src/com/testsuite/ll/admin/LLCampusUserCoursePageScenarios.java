...
public class LLCampusUserCoursePageScenarios extends BaseSetup {
	...
	/**
	 * This test selects Level1 on Course page and completes the activity named 'Listen and Identify' under 'Word Training Tab' 
	 * @throws Exception
	 */

	@Test(groups = { "CampusUser", "QC" }, priority = 1, retryAnalyzer = Retry.class, timeOut = 1000000)
	public void LL_CAMPUSUSER_037_CourseLevel1WordTrainingPageScenarios() {
	...
	public void LLCAMPUSUSER_038_CourseLevel1TextTrainingScenarios() {
	...
	@Test(groups = { "RC" }, priority = 2, retryAnalyzer = Retry.class)
	public void LLCAMPUSUSER_039_CourseLevel2WordTrainingScenarios() {
		// Step1: Login into application
		// https://qa.languagelive.voyagersopris.com/services/logon
		// Step2: After completion of Implementation cards
		// Step3: User displayed with reports pages
	...
	/**
	 * This test selects Level2 on Course page and completes the activity named Sort(Nouns and Verbs)  under 'Text Training Tab' 
	 * @throws Exception
	 */ 

	@Test(groups = { "CampusUser", "QC" }, priority = 2, retryAnalyzer = Retry.class, timeOut = 1000000)
	public void LL_CAMPUSUSER_040_CourseLevel2TextTrainingPageScenarios(){
		// Login into Language live product
		llLoginPage = new LLLoginPage(getDriver());
		llHomePage = (LLHomePage) llLoginPage.loginCredentials(llData.URL,llData.llCampusAdmin, llData.llCampusAdmin,
				LLLoginReturnPage.ADMIN_HOME_PAGE);
		...
		teacherRoleCoursePage.completeTTActivityAndVerifySummaryMessageForLevel2(llData.teacherRoleLLCourseTTSortNounAndVerbsNounArea,isIexploreBrowser());		
	}
	
	@Test(groups = { "RC", "QC" }, priority = 3, retryAnalyzer = Retry.class)
	public void LL_CAMPUSUSER_041_CourseSightWordsScenarios() {
		// Login into Language live product
		llLoginPage = new LLLoginPage(getDriver());
		llHomePage = (LLHomePage) llLoginPage.loginCredentials(llData.URL,llData.llCampusAdmin, llData.llCampusAdmin,
				LLLoginReturnPage.ADMIN_HOME_PAGE);
