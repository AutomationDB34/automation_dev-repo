...
import com.page.locators.ll.teacherrole.TeacherToolsCourseResourcesLocators;
import com.page.module.ll.level1activities.CommonFunctionalities;
import com.selenium.Dynamic;
import com.selenium.SafeActions;

public class TeacherToolsCourseResourcesPage extends CommonFunctionalities implements TeacherToolsCourseResourcesLocators {

	private WebDriver driver;
	
	public TeacherToolsCourseResourcesPage(WebDriver driver) {
		super(driver);
		this.driver=driver;
	}
	...
	{
		waitForSecs(10);
		safeJavaScriptClick(WORDTRAINING_TAB, LONGWAIT);
		waitForPageToLoad();
		waitForSecs(50);
	}
